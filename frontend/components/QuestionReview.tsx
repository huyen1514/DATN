      ...
      {isOpen && (
        <div className="px-6 pb-6 pt-2 border-t border-dashed border-neutral-100">
          ...
          {question.explanation && (
            <div className="p-5 bg-white rounded-[2rem] text-neutral-800 shadow-md border border-neutral-100">
              <div className="flex items-center gap-2 mb-3">
                <div className="bg-jp-red text-white p-1.5 rounded-lg">
                  <HelpCircle size={12} />
                </div>
              ...
              <p className="text-xs font-medium leading-loose text-neutral-700">
                {question.explanation}
              </p>
            </div>
          )}
