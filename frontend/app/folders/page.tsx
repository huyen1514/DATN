            ...
            <div className="max-w-5xl mx-auto">
                <div className="flex items-center justify-between mb-8">
                    <div>
                        ...
                        <p className="text-neutral-500 font-light">Quản lý các thư mục phân loại bộ thẻ của bạn.</p>
                    </div>
                    <button
                ...
                {isLoading ? (
                    ...
                    <div className="bg-white p-12 rounded-3xl border border-black/5 text-center flex flex-col items-center shadow-sm">
                        ...
                        <p className="text-neutral-500 mb-6 max-w-sm">Hãy tạo Không gian học đầu tiên để bắt đầu phân loại các bộ thẻ từ vựng của bạn một cách khoa học.</p>
